...
public class PagamentoApiHandler {
    ...
    @Operation(summary = "Grava confirmação de pagamento para o pedido.")
    @PostMapping("/pagamento/confirmacao")
    public ResponseEntity<String> confirmacaoPagamento(@RequestBody ConfirmacaoPagamentoDto param) {
        ...
        try {
            ...
            statusPagamento = transactionManager.runInTransaction(() -> pagamentoController.finalizarPagamento(param.idPedido(), null));
        ...
        return WebUtils.okResponse(statusPagamento);
    }
